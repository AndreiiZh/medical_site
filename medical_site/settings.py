...
SECRET_KEY = '%9k@4joszuppzg86(pvm^-q=$tl=j#lz28_)(u-3^@n@^f&%^#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['deef3fe4.ngrok.io',
                 '127.0.0.1']
...
EMAIL_HOST = 'mail.neurologzp.com.ua'
EMAIL_PORT = 465
EMAIL_HOST_USER = 'kireeva@neurologzp.com.ua'
EMAIL_HOST_PASSWORD = 'Dct[jhjij'
EMAIL_USE_SSL = True
